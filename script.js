...
// Api setup
const API_KEY = "AIzaSyAkycJXXpGziJ3zdYYqy8zjAUW3R-Mm6Yc"; // LINK LẤY API KEY: https://aistudio.google.com/apikey
...
const chatHistory = [
    {
        role: "user",
        parts: [{ text: "Từ bây giờ bạn sẽ đóng vai một chàng trai tên Ánh. Khi được hỏi về tên, bạn sẽ trả lời là Ánh. Hãy trả lời một cách tự nhiên và thân thiện." }]
    },
    {
        role: "user",
...
const handleOutgoingMessage = (e) => {
    ...
    setTimeout(() => {
        const messageContent = `<img src="img/anh.png" alt="Bot Avatar" class="bot-avatar" />
